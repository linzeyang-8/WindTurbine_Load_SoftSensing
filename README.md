...
ITP-MAML-1.5MW-Data_Quantification.txt  # 1.5MW target turbine: Data quantity quantification (20/30/50/70 samples) ITP-MAML_generates_pth.txt          # ITP-MAML training: Generate optimal θ*.pth parameters
